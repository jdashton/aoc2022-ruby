...
RSpec.describe AoC2022::SonarDepth do
  describe "#count_increases" do
    context "with [1, 3, 2]" do
      subject(:sonar_depth) { described_class.new StringIO.new(<<~NUMBERS) }
        1
        3
        2
      NUMBERS
      ...
      it "counts 1 increase" do
        expect(sonar_depth.count_increases).to eq 1
      end
    end
    ...
    context "with [1, 3, 2, 4]" do
      ...
      it "counts 2 increases" do
        expect(sonar_depth.count_increases).to eq 2
      end
    end
    ...
    context "with provided test data" do
      ...
      it "counts 7 increases" do
        expect(sonar_depth.count_increases).to eq 7
      end
    end
  end
  ...
  describe "#count_triplet_increases" do
    context "with [1, 3, 2, 4, 3, 5]" do
      ...
      it "counts 2 increases" do
        expect(sonar_depth.count_triplet_increases).to eq 2
      end
    end
    ...
    context "with [1, 3, 2, 4, 3, 0]" do
      ...
      it "counts 1 increase" do
        expect(sonar_depth.count_triplet_increases).to eq 1
      end
    end
    ...
    context "with provided test data" do
      ...
      it "counts 5 increases" do
        expect(sonar_depth.count_triplet_increases).to eq 5
      end
    end
  end
end
