...
RSpec.describe AoC2022::Puzzles::NotEnoughMinerals do
  context 'with provided test data' do
    ...
    xit 'produces the same log as the example' do
      expect { not_enough_minerals.max_rate_of_production(not_enough_minerals.blueprints.first) }.to output(<<~STRING).to_stdout
        == Minute 1 ==
  ...
  context 'with actual input data' do
    ...
    xit 'finds 33 is the sum of the quality levels of all of the blueprints in your list' do
      expect(not_enough_minerals.quality_levels).to eq 33
    end
  end
end
