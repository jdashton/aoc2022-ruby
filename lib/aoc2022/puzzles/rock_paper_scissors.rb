...
module AoC2022::Puzzles
  ...
  class RockPaperScissors
    def self.day02
      ...
      puts "Day  2, part A: the score will be #{ game.guide_alpha } if everything goes exactly according to the strategy guide."
      puts "Day  2, part B: the score will be #{ game.guide_beta } if everything goes exactly according to the strategy guide."
      puts
    end
